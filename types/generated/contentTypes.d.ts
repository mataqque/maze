...
export interface ApiInvalidListInvalidList extends Schema.CollectionType {
	...
	attributes: {
		list: Attribute.JSON;
		users_permissions_user: Attribute.Relation<'api::invalid-list.invalid-list', 'oneToOne', 'plugin::users-permissions.user'>;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
		createdBy: Attribute.Relation<'api::invalid-list.invalid-list', 'oneToOne', 'admin::user'> & Attribute.Private;
		updatedBy: Attribute.Relation<'api::invalid-list.invalid-list', 'oneToOne', 'admin::user'> & Attribute.Private;
	};
}
...
export interface ApiSentenceSentence extends Schema.CollectionType {
	...
	attributes: {
		...
		spanish: Attribute.String;
		userphone: Attribute.Relation<'api::sentence.sentence', 'manyToOne', 'plugin::users-permissions.user'>;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
		createdBy: Attribute.Relation<'api::sentence.sentence', 'oneToOne', 'admin::user'> & Attribute.Private;
		updatedBy: Attribute.Relation<'api::sentence.sentence', 'oneToOne', 'admin::user'> & Attribute.Private;
	};
}
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
	...
	attributes: {
		...
		sentences: Attribute.Relation<'plugin::users-permissions.user', 'oneToMany', 'api::sentence.sentence'>;
		cel: Attribute.String;
		interval: Attribute.String;
		invalid_list: Attribute.Relation<'plugin::users-permissions.user', 'oneToOne', 'api::invalid-list.invalid-list'>;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
